...
export function RiskAlertView({ keyRisk, onLearnMore, onOk }: RiskAlertViewProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-full bg-black text-white p-6">
            <div className="relative w-full max-w-sm text-center p-8 space-y-6 animate-fade-in opacity-0">
                ...
                <div className="space-y-3 animate-fade-in opacity-0 animation-delay-200">
                ...
                <div className="bg-gray-800/50 p-4 rounded-xl space-y-2 animate-fade-in opacity-0 animation-delay-400">
                ...
                <div className="flex flex-col space-y-4 pt-4 animate-fade-in opacity-0 animation-delay-600">
                    <Button
                        onClick={onLearnMore}
