...
export function MainCard() {
    return (
        <section className="mb-8">
            <div className="relative overflow-hidden rounded-xl glass-card p-6 text-white">
            ...
            <div className="relative z-10 flex flex-col items-start gap-4">
                ...
                <Button
                variant="secondary"
                className="mt-2 flex items-center justify-center gap-2 rounded-lg bg-white px-6 py-3 text-base font-bold text-black hover:bg-gray-200"
                >
